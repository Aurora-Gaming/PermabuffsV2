...
public static class DB
{
	...
	public static Dictionary<int, DBInfo> PlayerBuffs = new();
	...
	public static void Connect()
	{
		...
		SqlTableCreator sqlcreator = new(db, db.GetSqlType() == SqlType.Sqlite ? (IQueryBuilder)new SqliteQueryCreator() : new MysqlQueryCreator());
